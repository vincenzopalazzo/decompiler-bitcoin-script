//
// Created by https://github.com/vincenzopalazzo on 9/18/19.
//

#ifndef DECOMPILE_BITCOIN_SCRIPT_OPCODE_H
#define DECOMPILE_BITCOIN_SCRIPT_OPCODE_H
...
public:
    ...
    BitcoinOPCode() {
        ...
        opCodeList.emplace(0x54, "OP_4");
        opCodeList.emplace(0x55, "OP_5");
        opCodeList.emplace(0x56, "OP_6");
        opCodeList.emplace(std::stoul("0xa9", nullptr, 16), "OP_HASH160");
...
#endif //DECOMPILE_BITCOIN_SCRIPT_OPCODE_H
